...
let Project = (() => {
    ...
    let _whiteTest_decorators;
    let _fixBugInProduction_decorators;
    return class Project {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _whiteTest_decorators = [withBudget(10)];
            _fixBugInProduction_decorators = [withBudget(500)];
            __esDecorate(this, null, _whiteTest_decorators, { kind: "method", name: "whiteTest", static: false, private: false, access: { has: obj => "whiteTest" in obj, get: obj => obj.whiteTest }, metadata: _metadata }, null, _instanceExtraInitializers);
    ...
    return function (target, context) {
        return function (...args) {
            ...
            if (instance.budget > actionBudget) {
                ...
                console.log(`Insufficient funds for ${context.name.toString()}. Required ${actionBudget}, available ${instance.budget}!`);
            }
        };
    };
}
